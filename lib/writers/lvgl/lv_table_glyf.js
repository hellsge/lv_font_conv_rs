 ...
 *Define ${macroNameUpper}_GLYPH_BITMAP_ADDR as the memory address where the binary is loaded.*/
#ifndef ${macroNameUpper}_GLYPH_BITMAP_ADDR
#define ${macroNameUpper}_GLYPH_BITMAP_ADDR 0
#warning "Please define ${macroNameUpper}_GLYPH_BITMAP_ADDR to the flash memory address"
#endif

static const uint8_t * const glyph_bitmap = (const uint8_t *)${macroNameUpper}_GLYPH_BITMAP_ADDR;
